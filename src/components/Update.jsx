...
const Update = () => {
    ...
    const handleUpdateArt = event => {
        ...
        const updatedArt = { _id, name, email, imgurl, itemname, subcat, price, rating, customization, processingtime, stock, description };
            ...
            <div class="relative py-3 sm:mx-auto">
                ...
                <div class="relative border px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div class="lg:w-full mx-auto">
                        <form onSubmit={handleUpdateArt} className="">
                            <div className="flex">
                                <h1 className="font-bold uppercase text-5xl text-center bg-gradient-to-r from-blue-400 to-blue-900 inline-block text-transparent bg-clip-text mx-auto">Update your Item</h1>
                            </div>
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
                                ...
                                <div className="relative mt-5">
                                    <input id="imgurl" name="imgurl" defaultValue={imgurl} type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Image URL" />
                                ...
                                <div className="relative mt-5">
                                    <input id="subcat" name="subcat" defaultValue={subcat} type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Sub-category Name" />
                                ...
                                <div className="relative mt-5">
                                    <input id="price" name="price" defaultValue={price} type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Price" />
                                ...
                                <div className="relative mt-5">
                                    <input id="rating" name="rating" defaultValue={rating} type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Rating" />
                                ...
                                <div className="relative mt-5">
                                    <input id="customization" name="customization" defaultValue={customization} type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Customization(yes or no)" />
                                ...
                                <div className="relative mt-5">
                                    <input id="processingtime" name="processingtime" defaultValue={processingtime} type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Processing Time" />
                                ...
                                <div className="relative mt-5">
                                    <input id="stock" name="stock" defaultValue={stock} type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Stock (In stock or Made to order)" />
                            ...
                            <div className="relative mt-5">
                                <textarea id="description" name="description" defaultValue={description} type="text" className="peer placeholder-transparent h-32 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Short Description of your Item" />
